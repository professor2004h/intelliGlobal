      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              <h2 className="text-2xl font-bold mb-4">Intelli Global Conferences</h2>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a
                  ...
                  className="text-gray-300 hover:text-white transition-colors text-sm"
                >
                  Phone: {siteSettings?.contactInfo?.phone || "+44 20 4571 8752"}
                </a>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <a
                  href={`https://wa.me/${(siteSettings?.contactInfo?.whatsapp || "442045718752").replace(/[^0-9]/g, '')}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-300 hover:text-white transition-colors text-sm"
                >
                  WhatsApp: {siteSettings?.contactInfo?.whatsapp || "+44 20 4571 8752"}
                </a>
              </div>
            </div>
          </div>
