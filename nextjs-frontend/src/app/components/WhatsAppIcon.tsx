...
export default async function WhatsAppIcon() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full text-white shadow-lg hover:opacity-80 transition-opacity duration-200"
      style={{
        backgroundColor: '#25D366',
        color: 'white'
      }}
    >
      {/* Official WhatsApp brand icon (Bootstrap Icons path) */}
