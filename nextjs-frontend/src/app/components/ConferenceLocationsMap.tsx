          ...
          {showEmptyState && (
            <div className="w-full h-[400px] md:h-[500px] bg-gray-100 rounded-lg flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <p className="text-gray-600 mb-4">Conference locations will appear here once they are added to the CMS.</p>
                <p className="text-sm text-gray-500">Add locations in Sanity Studio to see the interactive map.</p>
              </div>
            </div>
          )}
