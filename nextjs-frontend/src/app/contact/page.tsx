      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">
            Have questions about our conferences? We&apos;d love to hear from you and help you
            join our global network of professionals and researchers.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-slate-600 leading-relaxed">
                  ...
                  with conference registrations, abstract submissions, and any other inquiries.
                </p>
              </div>
